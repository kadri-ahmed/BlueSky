...
let playgroundSharedDataDirectory = PlaygroundSupport.playgroundSharedDataDirectory
...
guard MDLAsset.canExportFileExtension(fileExtension) else {
    fatalError( "Couldn't export file format \(fileExtension)")
}
...
renderEncoder.setTriangleFillMode(.lines) // to render wireframe
